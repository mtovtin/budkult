    ...
    var method = {
        ...
        Init: function(setting) {
            ...
            var setting = $.extend({
                ...
                BviPanelImgXY: 1,
                BviPanelReload: 0,
                BviPanelText: 'Для людей з вадами зору',
                BviPanelCloseText: 'Звичайна версія сайту',
                BviCloseClassAndId: '',
                BviFixPanel: 1,
                BviPlay: 0,
                BviFlash: 0,
            ...
            function BviPanel() {
                ...
                $('<div class="bvi-container">'+
                    ...
                    '<div class="bvi-rows">'+
                    '<div class="bvi-title-header">Розмір шрифту</div>'+
                    '<div class="bvi-btn-group">'+
                    '<a href="#" id="bvi-font-size-minus" class="bvi-btn bvi-btn-default" title="Зменшити шрифт"><i class="bvi-glyphicon bvi-glyphicon-font"></i><b>-</b></a>'+
                    '<a href="#" id="bvi-font-size-plus" class="bvi-btn bvi-btn-default" title="Збільшити шрифт"><i class="bvi-glyphicon bvi-glyphicon-font"></i><b>+</b></a>'+
                    '</div>'+
                    ...
                    '<div class="bvi-col-xs-6 bvi-col-sm-6 bvi-col-md-3 bvi-col-lg-3 bvi-vertical">'+
                    '<div class="bvi-rows">'+
                    '<div class="bvi-title-header">Колір сайту</div>'+
                    '<div class="bvi-btn-group">'+
                    '<a href="#" id="bvi-color-white" class="bvi-btn bvi-btn-white" title="Колір сайту: Чоним по білому"><i class="bvi-glyphicon bvi-glyphicon-font"></i></a>'+
                    '<a href="#" id="bvi-color-black" class="bvi-btn bvi-btn-black" title="Колір сайту: Білим по чорному"><i class="bvi-glyphicon bvi-glyphicon-font"></i></a>'+
                    '<a href="#" id="bvi-color-blue" class="bvi-btn bvi-btn-blue" title="Колір сайту: Темно-синім по голубому"><i class="bvi-glyphicon bvi-glyphicon-font"></i></a>'+
                    '<a href="#" id="bvi-color-brown" class="bvi-btn bvi-btn-brown" title="Колір сайту: Коричневим по жовтому"><i class="bvi-glyphicon bvi-glyphicon-font"></i></a>'+
                    '<a href="#" id="bvi-color-green" class="bvi-btn bvi-btn-green" title="Колір сайту: Зеленим по темно-коричневому"><i class="bvi-glyphicon bvi-glyphicon-font"></i></a>'+
                    '</div>'+
                    ...
                    '<div class="bvi-col-xs-6 bvi-col-sm-6 bvi-col-md-3 bvi-col-lg-3 bvi-vertical">'+
                    '<div class="bvi-rows">'+
                    '<div class="bvi-title-header">Зображення</div>'+
                    '<div class="bvi-btn-group">'+
                    '<a href="#" id="bvi-img-on" class="bvi-btn bvi-btn-default" title="Увімкнути" style="color: green"><i class="bvi-glyphicon bvi-glyphicon-picture"></i></a>'+
                    '<a href="#" id="bvi-img-off" class="bvi-btn bvi-btn-default" title="Вимкнути" style="color: red"><i class="bvi-glyphicon bvi-glyphicon-picture"></i></a>'+
                    '<a href="#" id="bvi-img-grayscale" class="bvi-btn bvi-btn-default" title="Чорно-білі"><i class="bvi-glyphicon bvi-glyphicon-adjust"></i></a>'+
                    '</div>'+
                    ...
                    '<div class="bvi-rows">'+
                    '<div class="bvi-title-header">Додатково</div>'+
                    '<div class="bvi-btn-group">'+
                    ...
                    '<a href="#" id="bvi-close" class="bvi-btn bvi-btn-default" title="Звичайна версія сайту"><i class="bvi-glyphicon bvi-glyphicon-eye-close"></i></a>'+
                    '<a href="#" id="bvi-panel-hide" class="bvi-btn bvi-btn-default" title="Згорнути панель"><i class="bvi-glyphicon bvi-glyphicon-arrow-up"></i></a>'+
                    '</div>'+
                    '</div>'+
                    '</div>'+
                    '</div>'+
                    ...
                    '<a href="#" id="bvi-settings-close" class="bvi-btn bvi-btn-default" title="Закрити"><i class="bvi-glyphicon bvi-glyphicon-remove"></i> Закрити</a>'+
                    '</div>'+
                    '</div>'+
                    '</div>'+
                    '<div class="bvi-col-xs-12 bvi-col-sm-12 bvi-col-md-12 bvi-col-lg-12">'+
                    ...
                    '</div>'+
                    '</div>'+
                    '<div class="bvi-panel-show"><a href="#" id="bvi-panel-show" class="bvi-btn-panel-show" title="Показати панель"><i class="bvi-glyphicon bvi-glyphicon-eye"></i></a></div>'+
                    '</div>'+
...
Bvi: function (setting) {
    function BviBgColor() {
        if (Cookies.get("bvi-bgcolor") == 'white') {
            ...
            $('#bvi-color-text').html('Чорним по білому');
        } else {
        ...
        if (Cookies.get("bvi-bgcolor") == 'black') {
            ...
            $('#bvi-color-text').html('Білим по чорному');
        } else {
        ...
        if (Cookies.get("bvi-bgcolor") == 'blue') {
            ...
            $('#bvi-color-text').html('Темно-синім по голубому');
        } else {
        ...
        if (Cookies.get("bvi-bgcolor") == 'brown') {
            ...
            $('#bvi-color-text').html('Коричневим по жовтому');
        } else {
        ...
        if (Cookies.get("bvi-bgcolor") == 'green') {
            ...
            $('#bvi-color-text').html('Зеленим по темно-коричневому');
        } else {
    ...
    function BviPanelHide() {
        if (Cookies.get("bvi-panel-hide") == '1') {
            ...
            $("#bvi-close, .bvi-panel-close").click(function() {
                if (Cookies.get("bvi-voice") == '1') {
                    responsiveVoice.speak("Звичайна версія сайту", "Russian Female");
                }
            ...
            $("#bvi-font-size-minus").click(function() {
                ...
                if (size >= 0) {
                    ...
                    method.BviConsoleLog(setting.BviConsoleLog, "click", {"bvi-font-size[]":"Розмір шрифту: "+ size +" "+ _numbers});
                    if (Cookies.get("bvi-voice") == '1') {
